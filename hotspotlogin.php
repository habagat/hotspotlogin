...
<body onLoad=\"javascript:doOnLoad($result, '$loginpath?res=popup2&uamip=$uamip&uamport=$uamport&userurl=$userurl&redirurl=$redirurl&timeleft=$timeleft','$userurldecode', '$redirurldecode', '$timeleft','$reply')\" onBlur = 'javascript:doOnBlur($result)' bgColor = '#c0d8f4'>";
if ($result == 2) {
    echo "
...
if ($result == 1) {
  ...
  echo "
  <center>
    <h2 id='timer' style=\"color:yellow;\" ></h2>
    <!--
    <a href=\"http://$uamip:$uamport/logoff\">Logout</a>
        -->
    <!-- Logout button -->
    <input type='button' onclick=\"location.href='http://$uamip:$uamport/logoff'\" value=$centerLogout />  
  </center>
</body>
</html>";
}
...
if (($result == 3) || ($result == 13)) {
  ...
  <center>
    ...
    <a href=\"http://$uamip:$uamport/prelogin\">$centerLogin</a>
        -->
     <!-- Login button -->
    <input type='button' onclick=\"location.href='http://$uamip:$uamport/prelogin'\" value=$centerLogin />
  </center>
</body>
</html>";
}
